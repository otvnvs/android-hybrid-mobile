...
public class ConfigWebViewClient extends WebViewClient {
    ...
    private final WebServiceRegistry mServiceRegistry; // Added registry framework reference

    public ConfigWebViewClient(Context context, AppConfig config) {
        this.mContext = context;
        this.mConfig = config;
        this.mServiceRegistry = new WebServiceRegistry(context); // Instantiate compilation map
    }
@Override
